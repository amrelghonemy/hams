    ...
    <div className="container-custom py-12 md:py-20 max-w-2xl">
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-soft">
          <h2 className="text-lg font-display text-blush-400 mb-6">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="label-text">{locale === "ar" ? "الاسم" : "Name"}</label>
                <input type="text" required className="input-field rounded-xl w-full" />
              </div>
              <div>
                <label className="label-text">{locale === "ar" ? "البريد الإلكتروني" : "Email"}</label>
                <input type="email" required className="input-field rounded-xl w-full" />
              </div>
              <div>
                <label className="label-text">{locale === "ar" ? "رقم المحمول" : "Phone"}</label>
                <input type="tel" className="input-field rounded-xl w-full" />
              </div>
              <div>
                <label className="label-text">{locale === "ar" ? "الرسالة" : "Message"}</label>
                <textarea required rows={5} className="input-field rounded-xl w-full resize-none" />
              </div>
        ...
        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-soft">
          ...
          <div className="space-y-4 text-sm">
            ...
            <a
              href="mailto:info@hamsstyle.com"
              className="flex items-center gap-3 p-4 bg-rose-50 rounded-2xl hover:bg-rose-100 transition-colors"
            >
              <div className="w-10 h-10 bg-blush-400 rounded-full flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <p className="text-charcoal-400">info@hamsstyle.com</p>
              </div>
            </a>
            <a
              href="https://instagram.com/hamss_tyle"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-4 bg-rose-50 rounded-2xl hover:bg-rose-100 transition-colors"
            >
              ...
              <div>
                <p className="font-medium text-charcoal-700">Instagram</p>
                <p className="text-charcoal-400">@hamss_tyle</p>
              </div>
            </a>
          </div>
        </div>
