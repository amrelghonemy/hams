...
db.exec(`
  ...
  CREATE TABLE IF NOT EXISTS addresses (
    ...
    governorate TEXT, city TEXT, area TEXT, street TEXT,
    building TEXT, apartment TEXT, notes TEXT, is_default INTEGER DEFAULT 0,
  ...
  CREATE TABLE IF NOT EXISTS orders (
    ...
    customer_email TEXT, customer_phone TEXT NOT NULL,
    governorate TEXT, city TEXT, area TEXT, street TEXT,
    building TEXT, apartment TEXT, address_notes TEXT,
    subtotal REAL NOT NULL, shipping_cost REAL DEFAULT 0,
    discount_amount REAL DEFAULT 0, total REAL NOT NULL,
    payment_method TEXT DEFAULT 'cod', status TEXT DEFAULT 'pending',
  ...
  CREATE TABLE IF NOT EXISTS order_items (
    ...
    product_name_en TEXT, product_name_ar TEXT,
    product_image TEXT, size TEXT, color TEXT,
  ...
  CREATE TABLE IF NOT EXISTS discount_codes (
    ...
    min_order REAL DEFAULT 0, max_uses INTEGER,
...
const categories = [
  ...
  ["Outerwear", " jackets وعبايات", "outerwear", "/images/cat-outerwear.jpg", "Jackets, abayas and more", "جاكيتات وعبايات والمزيد", 5],
...
const products = [
  ...
  ["Silk Blend Blouse", "بلوزة قطن مدمج بالحرير", "silk-blend-blouse", "Luxurious silk blend blouse with elegant draping", "بلوزة فاخرة من القطن المدمج بالحرير مع ت draping أنيق", 899, null, 2, "HS-TOP-001", 30, [productImages[2], productImages[3]], '["XS","S","M","L","XL"]', '["أبيض","وردي","كحلي"]', 1, 0, 1, 4.5, 18, '["new"]'],
  ...
  ["Structured Blazer", "بليزر م Structured", "structured-blazer", "Professional structured blazer for a polished look", "بليزر مهني مفصل لإطلالة أنيقة", 1399, null, 5, "HS-OUT-003", 10, [productImages[3], productImages[5]], '["S","M","L","XL"]', '["أسود","كحلي","بيج"]', 0, 1, 1, 4.8, 19, '["bestseller"]'],
];
...
console.log("Admin login: admin@hamsstyle.com / admin123");
console.log("Discount code: WELCOME10 (10% off, min 300 EGP)");
