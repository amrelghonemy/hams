      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {features.map((feat, i) => (
            <div
              key={i}
              className="text-center group bg-white rounded-3xl p-6 md:p-8 shadow-md shadow-[#d4a5a5]/10 hover:shadow-xl hover:shadow-[#c97b7b]/15 transition-all duration-400 hover:-translate-y-1"
            >
              <div className="w-16 h-16 mx-auto mb-5 bg-gradient-to-br from-[#f5e6e0] to-[#eeddd6] flex items-center justify-center text-[#c97b7b] rounded-full group-hover:bg-[#c97b7b] group-hover:text-white transition-all duration-400 shadow-sm">
                {feat.icon}
              </div>
              <h3 className="text-sm font-semibold text-[#5c3a3a] mb-2">
                {t(locale, feat.titleKey)}
              </h3>
              <p className="text-xs text-[#8c6262] leading-relaxed">
